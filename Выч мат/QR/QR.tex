...
\begin{document}
	...
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{Рисунок1.png}}
	\end{figure}
	Второй тест, размер матрицы $4\times 4$:
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{Рисунок2.png}}
	\end{figure}
	Третий тест, размер матрицы $5\times 5$:
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{Рисунок3.png}}
	\end{figure}
	\newpage
	Четвертый тест, размер матрицы $6\times 6$:
	\begin{figure}[H]
		\center{\includegraphics[width = 1\textwidth]{Рисунок4.png}}
	\end{figure}
